...
echo "   python3 -m pytest tests/ -v (if pytest is available)"
echo "3. Test individual services:"
echo "   python3 api-gateway/src/main.py"
echo "   python3 auth-service/src/main.py"
echo "   python3 inference-pool/src/main.py"
echo "   python3 monitoring/src/main.py"
echo ""